...
if __name__ == '__main__':      
    ...
    if Optimization_case == "Unc_and_base":
        ...
        df_base_unc_pickle = "Df_base_" + str(kf) + "_with_unc"
        df_base_unc.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/Parametric_Study/df_base_pickle_unc/{}'.format(df_base_unc_pickle))
        
        df_opt_unc_pickle = "Df_opt_" + str(kf) + "_with_unc"
        df_opt_unc.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/Parametric_Study/df_opt_pickle_unc/{}'.format(df_opt_unc_pickle))
