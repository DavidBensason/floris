...
# -*- coding: utf-8 -*-
"""
Created on Wed May 20 13:17:15 2020
...
# -*- coding: utf-8 -*-
"""
Created on Wed May 20 13:12:00 2020
...
if __name__ == '__main__':
    ...
    D = 140 #input list of testsing diameters 
    y_n = 11
    #for i in D: 
        
    # Set wind farm to N_row x t_row grid with constant spacing 
    kf= "Fishermans_D="+ str(D) +"_spc=" + str(y_n) + "_no_scale"
    zf = "Fishermans"
