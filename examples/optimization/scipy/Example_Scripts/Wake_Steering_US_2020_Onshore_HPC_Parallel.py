...
## Example script for running yaw angle optimization for onshore farms on HPC. Example farm in this case
## is Border Winds Project 
...
if __name__ == '__main__':
    ...
    # Load USWTDB data from pickle file
    ...
    ## Reinitialize flow field and specify the ambient TI. In this case, 8%
    ...
    #UNC OPTION if using wind direction variability
