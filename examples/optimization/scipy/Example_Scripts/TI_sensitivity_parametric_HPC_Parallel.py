...
## Example script for looking at the sensitivity of wake steering performance to TI. In this case, 
## we are using a constant layout of 7x7 grid with SP of 250, avg ws of 7.5.
if __name__ == '__main__':      
    ...
    plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/TI_Study/farm_layout/{}'.format(layout_name))
    # ================================================================================
    ...
    if Optimization_case == "Just_Base":
        ...
        #df_base.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/TI_Study/df_base_pickle/{}'.format(df_base_pickle))
        
        df_opt_pickle = "Df_opt_" + str(kf) + "_without_unc"
        #df_opt.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/TI_Study/df_opt_pickle/{}'.format(df_opt_pickle))
        ...
        #plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/TI_Study/farm_report/{}'.format(report_farm_without_unc))
        ...
        if scale_ws_avg:
            data = data.append(pd.DataFrame({'Farm Name': str(kf),'Rated Power': P_r, 'Specific Power':SP, '#Turbine': int(Num_Turb),'Turbine_D':int(D),
                                             'Avg_ws': float(des_avg_ws),'TI': float(TI),
            ...
            data = data.append(pd.DataFrame({'Farm Name': str(kf), 'Rated_Power': P_r, 'Specific_Power':SP,'Turb_spc': rel_spc, 
                                             'TI': float(TI),'AEP_No_Wake': power_rose.total_no_wake, 
        ...
        #data.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/TI_Study/tabular_data_pickle/{}'.format(table_pickle))
