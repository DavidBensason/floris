...
if __name__ == '__main__':
    ...
    kf3 = (mf.loc[mf['p_name'] == "Chisholm View"])
    kf2 = (mf.loc[mf['p_name'] == "Chisholm View II"])
    kf = pd.concat([kf3,kf2], ignore_index=True)
    wf_coordinate = [kf["ylat"].mean(),kf["xlong"].mean()]
    kf1 = str(kf['p_name'].iloc[0])+ "_with"
    ...
    plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/AWAKEN/Saved_Fig/{}'.format(layout_name))
    #ax.set_title('Baseline flow for U = 8 m/s, Wind Direction = 270$^\circ$')
   ...
   #Plot Wind Rose
    ...
    plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/AWAKEN/Saved_Fig/{}'.format(windrose_name))
   ...
   # ti_ws = str(kf1) + "_ti_ws.png"
    ...
    if Optimization_case == "Unc_and_base":
        ...
        plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/AWAKEN/Saved_Fig/{}'.format(report_farm_without_unc))
        plt.show()
        ...
        data = data.append(pd.DataFrame({'Farm Name': kf['p_name'].iloc[0], '#Turbine': len(kf), 'Farm_lat':kf["ylat"].mean(), 'Farm_lon': kf["xlong"].mean(), 'AEP_No_Wake': power_rose.total_no_wake, 
                                         ...
                                         'AEP_Gain_Opt': 100.* power_rose.percent_gain , 'Loss_Red_Opt':100.* power_rose.reduction_in_wake_loss}, 
                                         index=[0]), ignore_index=True)
        table_pickle = "Pickle_table_" + str(kf1) + "_without_unc"
        data.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/AWAKEN/Saved_Fig/{}'.format(table_pickle))
        ...
        plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/AWAKEN/Saved_Fig/{}.png'.format(table_image))
