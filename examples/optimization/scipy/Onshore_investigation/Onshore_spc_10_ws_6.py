...
for i in D_list: 
    ...
    for ii in SP_list:
        ...
        plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/Onshore_investigation/farm_layout/{}'.format(layout_name))
        # ================================================================================
        ...
        if Optimization_case == "Unc_and_base":
            ...
            # Save farm report with designated name and path (this case  HPC)
            report_farm_without_unc = str(kf) +"_report_without_unc.png"
            plt.savefig(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/Onshore_investigation/farm_report/{}'.format(report_farm_without_unc))
            ...
            data.to_pickle(r'/home/dbensaso/code/floris/examples/optimization/scipy/Saved_Fig/Onshore_investigation/tabluar_data_pickle/{}'.format(table_pickle))
